...
export default function HomeSection({title, type ,getRamaData, array, getSantas, getSongs, search, setSearch}) {
    
    
    const {handleSubmit, handleSearch} = Searcher({search, setSearch ,type, getSantas, getSongs,})
